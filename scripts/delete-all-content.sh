...
STORAGE_TABLE_NAME=$(aws cloudformation describe-stacks --stack-name sauerpod-storage-stack --query "Stacks[0].Outputs[?OutputKey=='StorageTableNameCfn'].OutputValue" --output text)
